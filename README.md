...
**School Library** - a tool to record what books are in a school library and who borrows them.
...
```sh
  cd my-folder
  git clone  https://github.com/Ellon-M/school-library.git
```

### Usage

To view the project, run the file `main.rb`.
